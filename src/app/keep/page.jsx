...
function Page(props) {
    ...
    const handleFileChange = (event) => {
        ...
        if (file) {
            ...
            setFormDate ({file: file}),  // 선택된 파일을 상태에 저장
    ...
    const handleSubmit = async () => {
        try {
            ...
            data.append("notice_title", form.notice_title);
            data.append("notice_content", form.notice_content);
            data.append("file", formData.file); // 파일 추가
            data.append("notice_file_name", form.notice_file_name);
            data.append("notice_reg_date", form.notice_reg_date);
                    ...
                    <div className={adcommons.adcommons__main_container_box}>
                        ...
                        <div className={adcommons.adcommons__box}>
                            <TextField fullWidth label="메인 타이틀" id="fullWidth"
                                onChange={(e) => setForm({ ...formData, notice_title: e.target.value })}
                            />
                        </div>
                    </div>
                    ...
                    <div className={adcommons.adcommons__sub1_content_textarea}>
                        ...
                        <div className={adcommons.adcommons__box}>
                            <TextField
                                ...
                                rows={10}
                                fullWidth
                                onChange={(e) => setForm({ ...formData, notice_content: e.target.value })}
                            />
                        </div>
                    </div>
